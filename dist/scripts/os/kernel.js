...
(function (biOShock) {
    var Kernel = (function () {
        ...
        Kernel.prototype.krnBootstrap = function () {
            biOShock.Control.hostLog("bootstrap", "host"); // Use hostLog because we ALWAYS want this, even if _Trace is off.

            // Initialize our global queues.
            _KernelInterruptQueue = new biOShock.Queue(); // A (currently) non-priority queue for interrupt requests (IRQs).
            _KernelBuffers = new Array(); // Buffers... for the kernel.
            _KernelInputQueue = new biOShock.Queue(); // Where device input lands before being processed out somewhere.
            _Console = new biOShock.Console(); // The command line interface / console I/O device.
            ...
            _krnKeyboardDriver = new biOShock.DeviceDriverKeyboard(); // Construct it.
        ...
        Kernel.prototype.krnEnableInterrupts = function () {
            // Keyboard
            biOShock.Devices.hostEnableKeyboardInterrupt();
            // Put more here.
        };

        Kernel.prototype.krnDisableInterrupts = function () {
            // Keyboard
            biOShock.Devices.hostDisableKeyboardInterrupt();
            // Put more here.
        };
            ...
            if (_Trace) {
                if (msg === "Idle") {
                    ...
                    if (_OSclock % 10 == 0) {
                        ...
                        biOShock.Control.hostLog(msg, "OS");
                    }
                } else {
                    biOShock.Control.hostLog(msg, "OS");
                }
        ...
        Kernel.prototype.krnTrapError = function (msg) {
            biOShock.Control.hostLog("OS ERROR - TRAP: " + msg);
