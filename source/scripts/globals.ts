...
//
var APP_NAME: string    = "biOShock";   // 'cause Bob and I were at a loss for a better name.
var APP_VERSION: string = "21.12";   // What did you expect?
